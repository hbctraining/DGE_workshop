...
2. Download the [Salmon files using this link](https://www.dropbox.com/s/7cmczx9bhqkdd5j/data.zip?dl=1) and move the zip archive (`data.zip`) into your working directory. _These are the full dataset Salmon files that contain transcript abundances for each sample._
