...
You can download the directory with the quantification files for the 8 full dataset samples using the link below. Once you have them downloaded continue to follow the set of instructions:

1. [Download Salmon files](https://www.dropbox.com/s/shuaxoiecxx78mh/salmon.zip?dl=0)
