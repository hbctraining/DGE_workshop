...
We have a few example PCA plots below to get a feel for how to interpret them. The first example PCA plot below is what we hope for, with our treatment groups separating on PC1, which explains 89% of the variation in the data. 
