...
In the plot below, we would be a bit concerned about 'Wt_3' and 'KO_3' samples not clustering with the other replicates; we would want to explore the PCA to see if we see the same separation of samples.
